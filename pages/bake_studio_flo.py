...
st.set_page_config(page_title="BAKE STUDIO FLO", page_icon="🥖")
...
Let’s see if I can code my way to a more relaxed baking rhythm 😉  
Thanks for being part of this, you're the reason it works at all 🧡
""")
